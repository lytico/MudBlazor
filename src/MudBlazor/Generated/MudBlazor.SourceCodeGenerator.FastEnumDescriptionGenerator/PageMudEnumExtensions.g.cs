...
/// <summary>
/// Extension methods for <see cref="MudBlazor.Page"/> enum.
/// </summary>
public static class PageMudEnumExtensions {
    ...
    /// </summary>
    public static string ToDescriptionString(this MudBlazor.Page mudEnum)
    {
