...
/// <summary>
/// Extension methods for <see cref="MudBlazor.Animation"/> enum.
/// </summary>
public static class AnimationMudEnumExtensions {
    ...
    /// </summary>
    public static string ToDescriptionString(this MudBlazor.Animation mudEnum)
    {
        return mudEnum switch
        {
            MudBlazor.Animation.False => "false",
            MudBlazor.Animation.Pulse => "pulse",
            MudBlazor.Animation.Wave => "wave",
