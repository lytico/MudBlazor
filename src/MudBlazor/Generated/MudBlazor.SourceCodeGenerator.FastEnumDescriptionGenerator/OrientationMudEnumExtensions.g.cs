...
/// <summary>
/// Extension methods for <see cref="MudBlazor.Orientation"/> enum.
/// </summary>
public static class OrientationMudEnumExtensions {
    ...
    /// </summary>
    public static string ToDescriptionString(this MudBlazor.Orientation mudEnum)
    {
        return mudEnum switch
        {
            MudBlazor.Orientation.Portrait => "portrait",
            MudBlazor.Orientation.Landscape => "landscape",
