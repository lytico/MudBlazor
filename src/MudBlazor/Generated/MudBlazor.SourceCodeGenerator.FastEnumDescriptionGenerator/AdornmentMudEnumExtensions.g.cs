...
/// <summary>
/// Extension methods for <see cref="MudBlazor.Adornment"/> enum.
/// </summary>
public static class AdornmentMudEnumExtensions {
    ...
    /// </summary>
    public static string ToDescriptionString(this MudBlazor.Adornment mudEnum)
    {
        return mudEnum switch
        {
            MudBlazor.Adornment.None => "none",
            MudBlazor.Adornment.Start => "start",
            MudBlazor.Adornment.End => "end",
