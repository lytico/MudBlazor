...
/// <summary>
/// Extension methods for <see cref="MudBlazor.Size"/> enum.
/// </summary>
public static class SizeMudEnumExtensions {
    ...
    /// </summary>
    public static string ToDescriptionString(this MudBlazor.Size mudEnum)
    {
        return mudEnum switch
        {
            MudBlazor.Size.Small => "small",
            MudBlazor.Size.Medium => "medium",
            MudBlazor.Size.Large => "large",
