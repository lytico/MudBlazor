...
/// <summary>
/// Extension methods for <see cref="MudBlazor.Variant"/> enum.
/// </summary>
public static class VariantMudEnumExtensions {
    ...
    /// </summary>
    public static string ToDescriptionString(this MudBlazor.Variant mudEnum)
    {
        return mudEnum switch
        {
            MudBlazor.Variant.Text => "text",
            MudBlazor.Variant.Filled => "filled",
            MudBlazor.Variant.Outlined => "outlined",
