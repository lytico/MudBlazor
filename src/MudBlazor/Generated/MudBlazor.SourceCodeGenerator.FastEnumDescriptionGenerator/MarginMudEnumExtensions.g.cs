...
/// <summary>
/// Extension methods for <see cref="MudBlazor.Margin"/> enum.
/// </summary>
public static class MarginMudEnumExtensions {
    ...
    /// </summary>
    public static string ToDescriptionString(this MudBlazor.Margin mudEnum)
    {
        return mudEnum switch
        {
            MudBlazor.Margin.None => "none",
            MudBlazor.Margin.Dense => "dense",
            MudBlazor.Margin.Normal => "normal",
